...
// //Parks Right side
// //Pixel at fron
// public class Avocado_Detector extends LinearOpMode {
...
//                 robot.resetMotors();
//                 while (robot.lDistance.getDistance(DistanceUnit.CM) > 9.0 || robot.rDistance.getDistance(DistanceUnit.CM) > 9.0)
//                 {
//                     robot.move(-.7, -.7, -.7, -.7);
//                 }
...
//                     robot.resetMotors();
//                     while (robot.lDistance.getDistance(DistanceUnit.CM) > 10.0 || robot.rDistance.getDistance(DistanceUnit.CM) > 10.0)
//                      {
//                          robot.move(-.7, -.7, -.7, -.7);
//                      }
...
//             {
//                 robot.resetMotors();
//                 while (robot.lDistance.getDistance(DistanceUnit.CM) > 8.0 || robot.rDistance.getDistance(DistanceUnit.CM) > 8.0)
//                 {
//                     robot.move(-.7, -.7, -.7, -.7);
//                 }
